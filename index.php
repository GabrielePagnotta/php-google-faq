...
$domande=[
    ...
    [
        ...
        Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.<br><br>
...
<body>
    <header>
        ...
        <span class="privacy-font">Privacy e termini</span>
        </div>
        <nav>
            <ul>
                <li>Introduzione</li>
